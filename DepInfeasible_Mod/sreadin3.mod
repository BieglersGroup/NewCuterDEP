...
subject to consdep1{i in 1..1}:
	(x[i]*us[i]/(2*a) + x[i-1]*us[i-1]/(2*a) + x[i]*n - x[i-1]*n + us[i]*cos(2*pi*i/n)/(-2*a) + us[i-1]*cos(2*pi*(i-1)/n)/(-2*a))
	-(x[i]*us[i]/(2*a) + x[i-1]*us[i-1]/(2*a) + x[i]*n - x[i-1]*n + us[i]*cos(2*pi*i/n)/(-2*a) + us[i-1]*cos(2*pi*(i-1)/n)/(-2*a))^2 = 100;
